...
{
    // Setting ownsHandle to false prevents exceptions (on the native side?) when opening and closing many readers, but is it actually correct?
    public UnityFileHandle() : base(IntPtr.Zero, false) 
    {
    }
