...
namespace MicroUtils.UnityFilesystem.Parsers
{
    ...
    internal class AssetBundleParser : IObjectParser
    {
        ...
        public Optional<ITypeTreeValue> TryParse(ITypeTreeValue obj, SerializedFile sf)
        {
            ...
            var preloadTable = Optional<PPtr[]>.None;
                ...
                o.TryGetField<Map>("m_Container")
                    ...
                    .Map(entries =>
                        entries.Choose(entry =>
                        {
                            ...
                            var value =
                                v.TryGetObject()
                                    .Bind(o =>
                                    {
                                        ...
                                        return Optional.Some((int preloadIndex) => (int preloadSize) => (PPtr asset) =>
                            ...
                            return Optional.Some((string key) => (AssetInfo value) => (key, value))
                                .Apply(key)
                                .Apply(value);
                        })
            ...
            var ab =
                Optional.Some((PPtr[] preloadTable) => (Dictionary<string, AssetInfo[]> containerInfo) => new AssetBundle(o, preloadTable, containerInfo))
                    .Apply(preloadTable)
                    .Apply(containerInfo);
